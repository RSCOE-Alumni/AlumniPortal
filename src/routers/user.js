...
const sendMail = async (mail, otp) => {
	const msg = {
		from: "umeshpatel3111@gmail.com",
		to: mail,
		subject: "one time password",
		text: `Your one time password fro the alumni portal is ${otp}`,
	};
	nodemailer
		.createTransport({
			service: "gmail",
			auth: {
				user: "umeshpatel3111@gmail.com",
				pass: "gemmhkbnbjtovuzz",
			},
			port: 465,
			host: "smtp.gmail.com",
		})
